<!--
  Source: prempawee-portfolio/docs/OPUS_4_7_GUIDANCE.md
  Source commit SHA: 19b678073779603ab78d020b57bb927530c906ec
  Copied to pawee-workflow-kit on 2026-04-20 (Phase 1.4b)
  This is a verbatim copy — do not edit in place. To update, re-copy
  from the source project after that project's doc has been updated,
  and bump the source commit SHA above.
-->
